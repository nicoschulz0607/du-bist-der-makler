    ...
    return (
      <LockedPage
        ...
        benefits={[
          ...
          'Automatische E-Mail-Bestätigungen per Resend',
          'Keine Doppelbuchungen durch Validierung',
        ]}
        upgradePrice="599 €"
      />
    )
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-[#DDDDDD] rounded-xl p-10 flex flex-col items-center text-center">
        ...
        <p className="text-[13px] text-text-secondary">Der Besichtigungskalender wird bald verfügbar sein.</p>
      </div>
    </div>
  )
}
