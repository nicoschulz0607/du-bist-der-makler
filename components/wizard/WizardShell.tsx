...
import Station8Kontakt, { type ContactFormData } from './stations/Station8Kontakt'
...
export default function WizardShell({
  ...
  const [contactData, setContactData] = useState<ContactFormData>({
    ...
    anschrift: profileData.anschrift ?? '',
  })
  ...
  function buildSidebar() {
    ...
    return (
      <LiveInseratPreview
        ...
        vorname={contactData.vorname || null}
        telefon={contactData.telefon || null}
